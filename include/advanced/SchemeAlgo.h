...
public:
	...
	uint64_tt* bs_cipher_PQl;
	// N * t_num * Ri_blockNum * 2
	uint64_tt* gs_cipher_PQl;
	// N * t_num * Ri_blockNum * 2
	uint64_tt* gs_cipher_PQl_T;
	// N * t_num * Ri_blockNum * 2
	uint64_tt* acc_cipher_PQl;
	// N * q_num * 2
	uint64_tt* modDown_cipher_Ql;
	...
	void malloc_bsgs_buffer(int bs, int gs, int sine_degree);
