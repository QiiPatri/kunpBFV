...
void BFVContext::modUpPQtoT_23(uint64_tt* output, uint64_tt* input, int l, int batch_size)
{
...
#define zeroPadding_modUpQjtoT_block 128
__global__
__launch_bounds__(
			...
			uint64_tt* QjHatInvVecModQj_23_device, uint64_tt* QjHatInvVecModQj_23_shoup_device, uint64_tt* QjHatVecModT_23_device, uint64_tt* Qjmodti_device)
{
	...
	register uint64_tt rb[max_p_num] = {0}; // sizeof(rb) must > gamma
	register float vv = 0;
...
__host__ void BFVContext::modUpQjtoT_23(uint64_tt* output, uint64_tt* input, int l, int batch_size)
{
	...
	dim3 zeroPadding_modUpQjtoT_dim(batch_size, blockNum, N / zeroPadding_modUpQjtoT_block);
...
__host__ void BFVContext::modUpTtoPQl_23(uint64_tt* modUp_TtoQj_buffer, uint64_tt* exProduct_T_temp, int l, int batch_size)
{
...
__host__ void BFVContext::modDownPQltoQl_23(uint64_tt* output, uint64_tt* modUp_TtoQj_buffer, int l, int batch_size)
{
	// print_device_array(modUp_TtoQj_buffer, N, 2*t_num*Ri_blockNum, "ext_Ri");
